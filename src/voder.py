...
def show_oneline_usage():
    ...
    print("  quest    - Side-quests (utility tasks): download + Media Manipulation (cut, remove, merge, silence, soundlevel, bassboost, speed, pitch, reverb, loudnorm, ...). Run `quest` with no args to list them all.")
    ...
    print("  Run `python voder.py quest` (no args) to see all available side-quests grouped by category.")
    print("  Category: Media Manipulation — convert, cut, remove, merge, silence, reverse, fade,")
    print("                                     soundlevel, bassboost, speed, pitch, glue, reverb, loudnorm, noframes")
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        if sys.argv[1] == "cli" and len(sys.argv) == 2:
            from voders.cli import interactive_cli_mode
