...
def generate_system_prompt(session_type='interactive', user_input='', last_user_msg_time=None, last_vadar_reply_time=None, exclude_session=None):
    ...
    parts.append("")
    parts.append("### Tags:")
    parts.append("- <think>...</think> — my reasoning about what the user wants and what I should do. This is MY thinking, separate from the model's built-in thinking.")
    ...
    parts.append("")
    parts.append("### Rules:")
    parts.append("1. I ALWAYS start with <think>. I reason about the request before doing anything.")
    parts.append("2. After <think>, I emit <decide> with my plan.")
    ...
    parts.append("8. I NEVER emit raw text outside of tags. Everything goes inside a tag.")
    parts.append("")
    parts.append("### Example 1: Simple question (no act needed)")
    parts.append("<think>The user is asking how many R's are in strawberry. This is a simple question, no VODER command needed.</think>")
    ...
    parts.append("<think>The user wants to transcribe an audio file. I'll use STT mode.</think>")
    ...
    parts.append("<think>The user wants to isolate the second speaker, enhance them, then put them back. This requires: SS to extract speaker 2, SE to enhance, SS to extract all, SVS for non-vocals, mix to reassemble, glue to align with video.</think>")
    ...
    parts.append("<think>I need to check what audio files are available in the results directory.</think>")
    ...
    parts.append("1. THINK: <think>...</think>")
